...
function asegurarEstilosGaleriaFotos() {
  ...
  estilo.textContent = `
    ...
    .contenedor-foto-producto .foto-navegacion{
      ...
      color:#171717;
      background:rgba(238,232,230,.90);
      border:1px solid var(--color-principal,#98371e);
      border-radius:9px;
    ...
    .contenedor-foto-producto .foto-anterior{ left:5px; }
    .contenedor-foto-producto .foto-siguiente{ right:5px; }
    ...
    */
    ...
    /*
      Las fotos 2, 3 y 4 suelen venir con margen blanco incorporado
      en el archivo. Se hace un recorte VISUAL moderado y uniforme.
      La proporción original se conserva porque la escala es idéntica
      en ambos ejes.
    */
    html body #productos#productos .tarjeta-producto .contenedor-foto-producto .foto-producto.foto-recorte-secundario,
    html body #productosComparados#productosComparados .tarjeta-producto .contenedor-foto-producto .foto-producto.foto-recorte-secundario{
      transform:scale(1.163) !important;
    ...
    /* Navegación dentro del zoom, superpuesta sin crear márgenes. */
    .zoom-imagen-overlay .zoom-foto-navegacion{
      ...
      transform:translateY(-50%);
      color:#171717;
      background:rgba(238,232,230,.92);
      border:1px solid var(--color-principal,#98371e);
      border-radius:10px;
    ...
    /*
      ...
      El recorte de las fotos secundarias es uniforme y solo elimina
      aproximadamente el borde exterior incorporado en el archivo.
    */
    ...
    html body .zoom-imagen-overlay .zoom-imagen-ampliada.zoom-recorte-secundario{
      transform:scale(1.163) !important;
      transform-origin:center center !important;
    }
    ...
    @media (max-width:650px){
      ...
      .zoom-imagen-overlay .zoom-foto-anterior{ left:5px; }
      .zoom-imagen-overlay .zoom-foto-siguiente{ right:5px; }
...
function asegurarNavegacionZoomFotos() {
  ...
  if (!botonAnteriorZoom) {
    ...
    overlay.appendChild(botonAnteriorZoom);
  }
  ...
  if (!botonSiguienteZoom) {
    ...
    overlay.appendChild(botonSiguienteZoom);
  }
  ...
  if (!indicadoresZoom) {
    ...
    overlay.appendChild(indicadoresZoom);
  }
